...
y_time_out = TimeDistributed(Dense(units=2, name='output_time'))(second_recurrent_time)
...
y_temp_out = TimeDistributed(Dense(units='2', name='output_time'))(second_recurrent_temp)

# Build Predictions
concatenated = Concatenate()([y_all_out_reshaped, y_time_out, y_temp_out])
final_dense_first = TimeDistributed(Dense(units='64', activation='relu', kernel_regularizer=regularizers.l2(0.01)))(concatenated)
final_dense_second = TimeDistributed(Dense(units='32', activation='relu', kernel_regularizer=regularizers.l2(0.01)))(final_dense_first)
final_dense_third = TimeDistributed(Dense(units='16', activation='relu', kernel_regularizer=regularizers.l2(0.01)))(final_dense_second)
# Remove Time Data
flattened = Flatten()(final_dense_third)
